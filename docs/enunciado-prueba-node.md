...
**Fecha:** 2026-06-10 · **Tecnología:** Node.js · **Plazo de entrega:** 3 días
...
- Cuando el stock sube **por encima** del stock mínimo (después de un ajuste), se debe cerrar automáticamente la alerta activa y registrar que fue resuelta.
...
2. **Cantidad mínima de orden:** la cantidad de una orden de compra debe ser al menos 2x el stock mínimo del producto.
...
Puedes usar herramientas de IA (Copilot, ChatGPT, etc.) para ayudarte en el desarrollo. Se valora la comprensión real de lo que se implementa más que la cantidad de código.
